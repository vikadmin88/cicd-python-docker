[![Python CI](https://github.com/vikadmin88/cicd-python-docker/actions/workflows/python-ci.yml/badge.svg)](https://github.com/vikadmin88/cicd-python-docker/actions/workflows/python-ci.yml)
